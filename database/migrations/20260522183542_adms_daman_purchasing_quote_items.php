...
final class AdmsDamanPurchasingQuoteItems extends AbstractMigration
{
    /**
     * Change Method.
     *
    ...
    {
        if (!$this->hasTable('adms_daman_purchasing_quote_items')) {

            $table = $this->table('adms_daman_purchasing_quote_items');

            $table
                // FK Quote
                ->addColumn('adms_daman_purchasing_quotes_id', 'integer', ['null' => false, 'signed' => false])
                ->addForeignKey('adms_daman_purchasing_quotes_id', 'adms_daman_purchasing_quotes', 'id', ['delete' => 'CASCADE', 'update' => 'CASCADE'])
                ...
                */
                ...
                // Índice
                ->addIndex(['adms_daman_purchasing_quotes_id'])
    ...
    {
        $this->table('adms_daman_purchasing_quotes_items')->drop()->save();
    }
}
