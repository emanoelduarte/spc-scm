...
class AddAdmsDamanPagesSeeder extends AbstractSeed
{
    ...
    public function run(): void
    {
        ...
        $pages = [
            ...
            ['name' => 'Solicitar XML da Nfe', 'controller' => 'RequestNfeXml', 'controller_url' => 'request-nfe-xml', 'directory' => 'nfes', 'obs' => 'Página para solicitar o XML completo da NF-e junto à SEFAZ', 'public_page' => 0, 'page_status' => 1, 'adms_daman_packages_page_id' => 1, 'adms_daman_groups_page_id' => 19],
            ['name' => 'Registrar Ciência da Emissão da Nfe', 'controller' => 'ManifestNfeAwareness', 'controller_url' => 'manifest-nfe-awareness', 'directory' => 'nfes', 'obs' => 'Página para registrar Ciência da Emissão da NF-e', 'public_page' => 0, 'page_status' => 1, 'adms_daman_packages_page_id' => 1, 'adms_daman_groups_page_id' => 19],
            ['name' => 'Visualizar DANFE da Nfe', 'controller' => 'ViewNfeDanfe', 'controller_url' => 'view-nfe-danfe', 'directory' => 'nfes', 'obs' => 'Página para gerar e visualizar o DANFE da NF-e', 'public_page' => 0, 'page_status' => 1, 'adms_daman_packages_page_id' => 1, 'adms_daman_groups_page_id' => 19],
            ['name' => 'Baixar XML da Nfe', 'controller' => 'DownloadNfeXml', 'controller_url' => 'download-nfe-xml', 'directory' => 'nfes', 'obs' => 'Página para realizar download do XML completo da NF-e', 'public_page' => 0, 'page_status' => 1, 'adms_daman_packages_page_id' => 1, 'adms_daman_groups_page_id' => 19],
