...
class AddAdmsDamanPagesSeeder extends AbstractSeed
{
    ...
    public function run(): void
    {
        ...
        $pages = [
            ...
            // Páginas Compras
            ['name' => 'Criar Compra', 'controller' => 'CreatePurchasing', 'controller_url' => 'create-purchasing', 'directory' => 'purchasing', 'obs' => 'Página para criar compra', 'public_page' => 0, 'page_status' => 1, 'adms_daman_packages_page_id' => 1, 'adms_daman_groups_page_id' => 12],
