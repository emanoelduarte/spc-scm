...
class LoadPageAdm
{
    ...
    private array $listPgPrivate = ["Dashboard", "ListUsers", "ViewUser", "CreateUser", "UpdateUser", "DeleteUser", "UpdatePasswordUser", "ListAccessLevels", "ViewAccessLevel", "UpdateAccessLevel", "CreateAccessLevel", "DeleteAccessLevel", "UpdateUserAccessLevels", "ListPackages", "CreatePackage", "ViewPackage", "UpdatePackage", "DeletePackage", "ListGroupsPages", "ViewGroupPage", "CreateGroupPage", "UpdateGroupPage", "DeleteGroupPage", "ListOrders",];

    /** @var array $listDirectory Recebe a lista de diretórios com as controllers */
    private array $listDirectory = ["login", "dashboard", "users", "errors", "accessLevels", "orders", "packages", "groupsPages"];
