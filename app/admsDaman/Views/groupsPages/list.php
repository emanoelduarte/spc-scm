    ...
    <div class="card mb-4 border-light shadow">
        <div class="card-header hstack gap-2">
            ...
            <span class="ms-auto">
                ...
                <a href="<?= $_ENV['URL_ADM'] . 'create-group-page'; ?>" class="btn btn-success btn-sm"><i
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            ...
                            <a href="<?= $_ENV['URL_ADM'] . 'view-group-page/' . $id; ?>"
                            ...
                            <a href="<?= $_ENV['URL_ADM'] . 'update-group-page/' . $id; ?>"
                            ...
                            <?php  // Formulário para envio dos dados para deletar Grupo de página 
                                        ?>
                            <form id="formDelete<?= $id; ?>" action="<?= $_ENV['URL_ADM']; ?>delete-group-page"
