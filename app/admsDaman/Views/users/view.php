...
<div class="container-fluid px-4">
    ...
    <?php if (in_array("UpdateUserProjectAssociate", $this->data['buttonPermissions'])): ?>
        <div class="card mb-4 border-light shadow">
            <div class="card-header d-flex flex-column flex-sm-row gap-2">
                <span>Obras vinculadas ao usuário</span>
            </div>

            <div class="card-body">
                <?php
                // Verificar se há obras vinculadas ao usuário
