    ...
    <div class="card mb-4 border-light shadow">
        ...
        <div class="card-body">
            ...
            <form action="" method="POST" class="row g-3">
                ...
                <div class="col-lg-3 col-md-6 col-sm-12">
                    <label for="adms_daman_supplier_id" class="form-label">Locador</label>
                    ...
                    <select name="adms_daman_supplier_id" class="form-select" id="adms_daman_supplier_id">
                        ...
                        <?php
                            // Verificar se existe pacotes
                            if ($this->data['getSupplierTypeSelect'] ?? false) {

                                // Percorrer array de pacotes
                                foreach ($this->data['getSupplierTypeSelect'] as $getSupplierTypeSelect) {
                                    extract($getSupplierTypeSelect);

                                    // Verificar se deve manter selecionada a opção
                                    $selected = isset($this->data['form']['adms_daman_supplier_id']) && $this->data['form']['adms_daman_supplier_id'] == $id ? 'selected' : '';

                                    echo "<option value='$id' $selected>$trade_name</option>";
                                }
                            }
                            ?>
                    </select>
                ...
                <div class="col-lg-3 col-md-12 col-sm-12">
                    <label for="rental_contract" class="form-label">Contrato:</label>
                    <input type="text" class="form-control desabled" id="rental_contract" name="rental_contract"
                        value="<?= $this->data['form']['rental_contract'] ?? '';  ?>" placeholder="Contrato">
                </div>
                ...
                <div id="items-container" class="row g-3 ">
                    ...
                    <div class="row g-1 item-group mb-2 mt-n1">
                        ...
                        <div class="col-lg-1 col-md-12 col-sm-12">
                            ...
                            <?php endif; ?>
                            <input type="text" class="form-control desabled" id="rented_quantity"
                                name="items[<?= $index ?>][rented_quantity]"
                                value="<?= $item['rented_quantity'] ?? '';  ?>" placeholder="Qtd Locada">
                        </div>
                        ...
                        <div class="col-lg-1 col-md-12 col-sm-12">
                            ...
                            <?php endif; ?>
                            <input type="text" class="form-control desabled" id="returned_quantity"
