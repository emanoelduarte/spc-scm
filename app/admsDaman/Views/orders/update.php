                        ...
                        ?>
                            <div class="row g-1 item-group mb-2 mt-n1">
                                ...
                                <div class="col-lg-1 col-md-12 col-sm-12">
                                    ...
                                    <?php endif; ?>
                                    <input type="text" class="form-control desabled" id="quantity" name="items[<?= $index ?>][quantity]" value="<?= $item['quantity'] ?? '';  ?>" placeholder="Qtd">
                                </div>
                                ...
                                <div class="col-lg-1 col-md-12 col-sm-12">
                                    ...
                                    <?php endif; ?>
                                    <input type="text" class="form-control desabled" id="unit" name="items[<?= $index ?>][unit]" value="<?= $item['unit'] ?? '';  ?>" placeholder="Un">
                                </div>
