        ...
        <div class="card-body">
            ...
            <div class="row">
                <div class="col-xl-12 col-md-12">
                    <div class="card mb-4">
                        <div class="card-body"><strong>Status de Pedidos</strong></div>
                            ...
                            <div class="row g-3">
                                ...
                                <?php foreach ($this->data['statusCount'] as $status) : ?>
                                    ...
                                    <div class="col-xl-2 col-lg-3 col-md-4 col-sm-6">
                                        <div style="background: <?= $status['color'] ?>22; border-radius: 8px; padding: 14px;">
                                            <div style="display: flex; align-items: center; gap: 8px; margin-bottom: 8px;">
                                                <i class="fa-solid <?= $status['icon'] ?>" style="color: <?= $status['color'] ?>; font-size: 16px;"></i>
                                                <span style="font-size: 12px; font-weight: 500; color: <?= $status['color'] ?>;">
            ...
            <div class="row">
                ...
                <div class="col-xl-6 col-md-12">
                    <div class="card mb-4 shadow-sm border-0">
                        <div class="card-header fw-semibold bg-white justify-content-between d-flex align-items-center py-3">
                            <div>
                                    ...
                                    <?php foreach ($this->data['ordersAnalysisByProject'] as $index => $project) : ?>
                                        ...
                                        <li class="list-group-item d-flex align-items-center justify-content-between px-3 py-2">
                                            ...
                                            <div class="d-flex align-items-center gap-2">
                                                <span class="text-muted" style="font-size: 12px; min-width: 18px;"><?= $index + 1 ?>°</span>
                                                <i class="fas fa-hard-hat text-warning"></i>
                                                <span><?= htmlspecialchars($project['project_name']) ?></span>
                                            </div>

                                            <span class="badge bg-warning text-dark"><?= $project['total'] ?> pedido<?= $project['total'] > 1 ? 's' : '' ?></span>
