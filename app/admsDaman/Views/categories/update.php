    ...
    <div class="card mb-4 border-light shadow">
        <div class="card-header hstack gap-2">
            ...
            <span class="ms-auto d-sm-flex flex-row">
                ...
                <?php if (in_array("ListCategories", $this->data['buttonPermissions'])) : ?>
                ...
                <?php if (in_array("ViewCategory", $this->data['buttonPermissions'])) : ?>
                    <a href="<?= $_ENV['URL_ADM'] . 'view-category/' . ($this->data['form']['id'] ?? ''); ?>" class="btn btn-primary btn-sm me-1 mb-1"><i class="fa-solid fa-eye"></i> Visualizar</a>
                <?php endif; ?>
            </span>
        </div>
        ...
        <div class="card-body">
            ...
            <form action="" method="POST" class="row g-3">
                <input type="hidden" name="csrf_token" value="<?php echo CSRFHelper::generateCSRFToken('form_update_category'); ?>" id="">
