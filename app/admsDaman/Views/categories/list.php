        ...
        <div class="card-header hstack gap-2">
            ...
            <span class="ms-auto">
                <?php if (in_array("CreateCategory", $this->data['buttonPermissions'])): ?>
                    <a href="<?= $_ENV['URL_ADM'] . 'create-category'; ?>" class="btn btn-success btn-sm"><i class="fa-solid fa-user-plus"></i> Cadastrar</a>
                <?php endif; ?>
            </span>
        </div>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <?php if (in_array("ViewCategory", $this->data['buttonPermissions'])): ?>
                                        <a href="<?= $_ENV['URL_ADM'] . 'view-category/' . $id; ?>" class="btn btn-primary btn-sm me-1 mb-1"><i class="fa-solid fa-eye"></i> Visualizar</a>
                                    <?php endif; ?>

                                    <?php if (in_array("UpdateCategory", $this->data['buttonPermissions'])): ?>
                                        <a href="<?= $_ENV['URL_ADM'] . 'update-category/' . $id; ?>" class="btn btn-warning btn-sm me-1 mb-1"><i class="fa-regular fa-pen-to-square"></i> Editar</a>
                                    <?php endif; ?>

                                    <?php if (in_array("DeleteCategory", $this->data['buttonPermissions'])): ?>
                                        <?php  // Formulário para envio dos dados para deletar Categoria 
                                        ?>
                                        <form id="formDelete<?= $id; ?>" action="<?= $_ENV['URL_ADM']; ?>delete-category" method="POST" class="d-inline">
