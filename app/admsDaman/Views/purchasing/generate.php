    ...
    <div class="card mb-4 border-light shadow">
        ...
        <div class="card-header hstack gap-2">
            ...
            <span class="ms-auto d-sm-flex flex-row">
                <a href="<?= $_ENV['URL_ADM'] . 'list-purchasings'; ?>" class="btn btn-info btn-sm me-1 mb-1"><i class="fa-solid fa-list"></i> Listar</a>
            </span>
        ...
        <div class="card-body">
            ...
            <form action="" method="POST" class="row g-3">
                <input type="hidden" name="csrf_token" value="<?php echo CSRFHelper::generateCSRFToken('form_generate_purchasing'); ?>" id="">
                ...
                <div class="col-lg-2 col-md-6 col-sm-12">
                    ...
                    <input type="date" class="form-control" id="expected_receipt_date" name="expected_receipt_date" placeholder="dd/mm/yyyy">
                ...
                <div class="col-lg-1 col-md-12 col-sm-12">
                    ...
                    <input type="text" class="form-control desabled" id="adms_daman_order_id" name="adms_daman_order_id" value="<?= $this->data['getOrder']['id'] ?? '';  ?>" placeholder="N° do pedido" readonly>
                </div>
                ...
                <div class="col-lg-3 col-md-6 col-sm-12">
                    ...
                    <input type="hidden" name="adms_daman_project_id" class="form-control desabled" id="adms_daman_project_id" value='<?= $projectId ?>'>
                    <input type="text" name="project_name" class="form-control desabled" id="project_name" value='<?= $project_name  ?>' readonly>

                </div>

                <div class="col-lg-6 col-md-12 col-sm-12">
                    <label for="service" class="form-label">Descrição do serviço:</label>
                    <input type="text" class="form-control desabled" id="service" name="service" value="<?= $this->data['getOrder']['service'] ?? '';  ?>" placeholder="Descrição do serviço">
                </div>

                <div class="col-lg-6 col-md-12 col-sm-12">
                    <label for="delivery_address" class="form-label">End. Entrega:</label>
                    <input type="text" class="form-control desabled" id="delivery_address" name="delivery_address" value="<?= $this->data['getOrder']['project_adrress'] ?? '';  ?>" placeholder="N° do pedido">
                </div>
                ...
                <div class="col-lg-2 col-md-12 col-sm-12">
                    ...
                    <input type="text" class="form-control desabled" id="delivery_value" name="delivery_value" value="<?= $this->data['form']['delivery_value'] ?? '';  ?>" placeholder="R$ 0.00">
                </div>
                <div class="col-lg-4 col-md-12 col-sm-12">
                    <label for="discount_value" class="form-label">Desconto</label>
                    <input type="text" class="form-control desabled" id="discount_value" name="discount_value" value="<?= $this->data['form']['discount_value'] ?? '';  ?>" placeholder="R$ 0.00 ou %">
                </div>
                ...
                <div class="form-check">
                    <input class="form-check-input" type="radio" name="discount_type" id="discount_type2" value="percent">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="col-lg-12 col-md-12 col-sm-12">
                                            <input type="text" class="form-control" name="items[<?= $key ?>][description]" value="<?= $item['description']; ?>" readonly>
                                        </div>
                                    </td>
                                    <td>
                                        <input type="hidden" name="items[<?= $key ?>][adms_daman_measurement_units_id]" value="<?= $item['adms_daman_measurement_units_id']; ?>">

                                        <div class="col-lg-12 col-md-12 col-sm-12">
                                            <input type="text" class="form-control" name="items[<?= $key ?>][measurement_units]" value="<?= $item['measurement_units']; ?>" readonly>
                                        </div>
                                    </td>
                                    <td>
                                        <div class="col-lg-12 col-md-12 col-sm-12">
                                            <input type="text" class="form-control" name="items[<?= $key ?>][purchased_quantity]" value="<?= $item['purchased_quantity']; ?>" readonly>
                                        </div>
                                    </td>
                                    <td>
                                        <div class="col-lg-12 col-md-12 col-sm-12">
                                            <input type="text" class="form-control" name="items[<?= $key ?>][unit_price]" value="<?= $item['unit_price']; ?>" readonly>
                                        </div>
                                    </td>
                                    <td>
                                        <?php
                                    ...
                                    <td>
                                        <div class="form-check">
                                        <input type="checkbox" class="form-check-input" name="items[<?= $key ?>][selected_item]"  value="1" id="checkDefault">
                                        </div>
                                    </td>
                                </tr>
