        ...
        <div class="card-header hstack gap-2">
            ...
            <span class="ms-auto d-sm-flex flex-row">
                ...
                <?php if (in_array('ViewSupplier', $this->data['buttonPermissions'])): ?>
                    <a href="<?= $_ENV['URL_ADM'] . 'view-supplier/' . ($form['id'] ?? ''); ?>"
        ...
        <div class="card-body">
            ...
            <form action="" method="POST" class="row g-3">
                <input type="hidden" name="csrf_token"
                    value="<?= CSRFHelper::generateCSRFToken('form_update_supplier'); ?>">
                ...
                <div class="col-lg-4">
                    ...
                    <select name="adms_daman_suppliers_types_id" class="form-select"
                        id="adms_daman_suppliers_types_id">
                ...
                <div class="col-lg-2">
                    ...
                    <select name="supplier_status" class="form-select" id="supplier_status">
                        ...
                        <option value="1" <?= ((string) ($form['supplier_status'] ?? '') === '1') ? 'selected' : ''; ?>>Ativo</option>
                        <option value="0" <?= ((string) ($form['supplier_status'] ?? '') === '0') ? 'selected' : ''; ?>>Inativo</option>
                    </select>
                </div>
