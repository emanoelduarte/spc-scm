...
class ValidationPageService
{
    ...
    public function validate(array $data): array
    {
        ...
        $rules = [
            ...
            'adms_daman_packages_page_id' => 'required|integer',
            'adms_daman_groups_page_id' => 'required|integer',
        ];
        ...
        $messages = [
            ...
            'adms_daman_packages_page_id:required' => 'O campo pacote é obrigatório.',
            'adms_daman_packages_page_id:integer' => 'O campo pacote deve ser um número inteiro.',
            'adms_daman_groups_page_id:required' => 'O campo grupo é obrigatório.',
            'adms_daman_groups_page_id:integer' => 'O campo grupo deve ser um número inteiro.',
        ];
