...
class PageLayoutService
{
    public function configurePageElements(array $data): array
    {
        ...
        $menu = ['Dashboard', 'ListUsers', 'ListOrders', 'ListPurchasings', 'ListProjects', 'ListSuppliers', 'ListAccessLevels', 'ListCategories', 'ListPackages', 'ListGroupsPages', 'ListPages', 'ListMaterialStock', 'ListBudgets','ListNfes', 'ListPurchaseDocuments', 'ListDirectExpenses', 'ListFinancialDisbursements'];
