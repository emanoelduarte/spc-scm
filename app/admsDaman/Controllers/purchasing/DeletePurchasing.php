...
/**
 * Controller para exclusão de compras
 *
 * Esta classe gerencia o processo de exclusão de compra no sistema. Ela lida com a validação dos dados
 * do formulário, a exclusão do pedido do banco de dados e o registro de logs para operações bem-sucedidas ou
 * falhas. Além disso, redireciona o usuário para a página de listagem de compra com mensagens de sucesso ou erro.
 * 
 * @author Emanoel <emanoel.c.duarte@hotmail.com>
 * 
 * @package App\adms\Controllers\purchasing
 */
class DeletePurchasing
{
    ...
    public function index(): void
    {
        ...
        $deletePurchasing = new PurchasingRepository();
        $this->data['purchasing'] = $deletePurchasing->getPurchasing((int) $this->data['form']['id']);
        ...
        $result = $deletePurchasing->deletePurchasing($this->data['form']['id']);
